...
<a href="/api/instructor/add-course-to-user">Add A course To a user</a>
    ...
    <div class="createform">
        <form:form action="${pageContext.request.contextPath}/api/courses/new" method="post" modelAttribute="course" enctype="multipart/form-data">
            <div class="formCo">
                <h1>Add Course</h1>
                <label for="courseName">Course Name:
                    <form:errors path="name" class="text-danger"/>
                    <form:input class="form-control" path="name"  placeholder="Course Name"/>
                </label>
