...
<head>
    ...
    <style>
        body {
            height: 100vh;
            margin: 0;
            background: linear-gradient(rgba(8, 0, 58, 0.7), rgba(8, 0, 58, 0.7)), url('./emmanuel-college-georgia_hero (1).jpg');
        }
        .navbar {
            position: fixed;
            top: 0;
        ...
        .formCo label select.inputrg:focus {
            border-color: #00bfff;
        }
        .formCo label span {
...
<a href="/api/instructor/add-course-to-user">Add A course To a user</a>
    ...
    <div class="container">
        ...
        <form action="/api/instructor/add-course-to-user" method="post" class="formCo">
            <label for="userId">Select User:</label>
            <select name="userId" id="userId" class="inputrg">
            ...
            <select name="courseId" id="courseId" class="inputrg">
            ...
            <br>
            <input type="submit" value="Add Course" class="submit">
        </form>
    </div>
</body>
</html>
