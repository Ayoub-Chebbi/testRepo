                    ...
                    <article class="card">
                        ...
                        <div class="project-info">
                            <div class="flex">
                              ...
                              <c:forEach var="course" items="${courses}"></c:forEach>
                                <div class="project-title">
                                  <span class="tag">Course Name: <c:out value="${course.name}" /></span>
                                </div>
                                        ...
                                        <span class="tag">Description :${course.description}</span>

                                        <span class="tag">Description :<c:out value="${course.instructor.name}" /></span>
