...
h1 {
 ...
 section {
    background: -webkit-linear-gradient(left, #171717, #242525);
    background: linear-gradient(to right, #1f2020, #1b1c1c);
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="butt">
                                ...
                                <button >
                                    <a href="${pageContext.request.contextPath}/api/users/${user.id}/edit">Edit</a>
